...
CREATE TABLE dbo.tb_char(id int IDENTITY PRIMARY KEY, c1 char(500), c2 char(500))
...
-- 测试数据检索
DECLARE @t_char TABLE(id int, c1 char(500), c2 char(500))
SET @d11 = GETDATE()
	INSERT @t_char
...
CREATE TABLE dbo.tb_varchar(id int IDENTITY PRIMARY KEY, c1 varchar(500), c2 varchar(500))
...
-- 测试数据检索
DECLARE @t_varchar TABLE(id int, c1 varchar(500), c2 varchar(500))
SET @d21 = GETDATE()
	INSERT @t_varchar
