...
CREATE TABLE dbo.tb_char(id int IDENTITY, c1 char(1000))
...
SET @d11 = GETDATE()
	EXEC(N'
	ALTER TABLE dbo.tb_char DROP COLUMN c1')
SET @d12 = GETDATE()

-- 测试插入数据到 varchar 列
IF OBJECT_ID('dbo.tb_varchar') IS NOT NULL
	DROP TABLE dbo.tb_varchar
CREATE TABLE dbo.tb_varchar(id int IDENTITY, c1 varchar(1000))
...
SET @d21 = GETDATE()
	EXEC(N'
	ALTER TABLE dbo.tb_varchar DROP COLUMN c1')
SET @d22 = GETDATE()
SELECT dlen = @len, d11 = @d11, d12 = @d12, d21 = @d21, d22 = @d22

DROP TABLE dbo.tb_char, dbo.tb_varchar
GO
